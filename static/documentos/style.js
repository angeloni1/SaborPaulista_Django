function filtro(filtroParametro) {
    ...
    $.ajax({
        type: "GET",
        url: addPathName + "/api/documents/?search="+filtroParametro,
        dataType: "json",
            ...
            for (var i = 0; i <= data.length - 1; i++) {
                ...
                newDocument = `
                    ...
                    ${data[i].miniatura != null ?
                        `<img data-name="" data-number="1" class="lightbox-trigger" src="${data[i].miniatura.replace(domain, currentPath)}" style="width:95%; height:95%;" />
